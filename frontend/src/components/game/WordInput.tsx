        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-3">
            <FormField
              ...
              name="word"
              render={({ field }) => {
                const hasWord = field.value.trim().length > 0;
                return (
                  <>
                    <FormItem className="flex-1 space-y-0">
                      <div className="relative group">
                        <div className={`absolute -inset-1 bg-linear-to-r ${isMyTurn ? 'from-primary/40 to-accent/40' : 'from-white/5 to-white/5'} rounded-3xl blur opacity-0 group-focus-within:opacity-100 transition duration-700`} />
                          ...
                          <FormControl>
                            <Input
                              ...
                              className={`
                                ...
                                ${isMyTurn ? "focus:border-primary/50 focus:bg-white/8" : "opacity-40 cursor-not-allowed"}
                              `}
                            />
                          </FormControl>
