...
import { ArrowLeft, UserPlus, Users, Shield, LogOut } from "lucide-react";
              ...
              {!isAuthenticated && (
                <div className="flex gap-3 pt-2 border-t border-white/5">
                  <Button
                    ...
                    className="flex-1 h-10 glass border-white/10 text-white/40 hover:text-primary hover:border-primary/40 rounded-xl transition-all text-[10px] font-black uppercase tracking-wider"
                  >
                    Register
                  </Button>
                  <Button
